...
## Run Metadata
- Generated (UTC): 2026-04-06T00:51:30.412755+00:00
- Seed: 20260535
...
- cluster_scale_closure: PASS; value=1.0968; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7014; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2522; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1214; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=814.0940; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
