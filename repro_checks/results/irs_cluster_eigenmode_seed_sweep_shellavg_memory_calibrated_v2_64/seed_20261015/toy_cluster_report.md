...
## Run Metadata
- Generated (UTC): 2026-04-06T00:53:10.218378+00:00
- Seed: 20261015
...
- Closure at R500, ground mode only: 1.020
- Closure at R500, full eigenmode sum: 1.069
- Higher-mode fraction at R500: 0.052
- Mean memory factor at R500: 0.936
- Predicted sigma at R500: 803.5 km/s
- Anchor sigma: 747.7 km/s
- Baryon fraction at R500: 0.124
...
- cluster_scale_closure: PASS; value=1.0686; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.6972; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2215; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1240; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=803.5429; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
