...
## Run Metadata
- Generated (UTC): 2026-04-06T00:51:51.602556+00:00
- Seed: 20260635
...
- Closure at R500, ground mode only: 1.067
- Closure at R500, full eigenmode sum: 1.116
- Higher-mode fraction at R500: 0.050
- Mean memory factor at R500: 0.936
- Predicted sigma at R500: 821.2 km/s
...
- cluster_scale_closure: PASS; value=1.1161; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7187; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2635; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1196; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=821.2012; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
