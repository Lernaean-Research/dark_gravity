...
## Run Metadata
- Generated (UTC): 2026-04-06T00:52:45.611037+00:00
- Seed: 20260895
...
- Closure at R500, full eigenmode sum: 1.088
- Higher-mode fraction at R500: 0.051
- Mean memory factor at R500: 0.936
- Predicted sigma at R500: 810.8 km/s
...
- cluster_scale_closure: PASS; value=1.0881; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.6836; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2373; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1225; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=810.8454; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
