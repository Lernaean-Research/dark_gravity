...
## Run Metadata
- Generated (UTC): 2026-04-06T00:53:06.270465+00:00
- Seed: 20260995
...
- Closure at R500, ground mode only: 1.050
- Closure at R500, full eigenmode sum: 1.099
- Higher-mode fraction at R500: 0.051
- Mean memory factor at R500: 0.936
- Predicted sigma at R500: 814.9 km/s
...
- cluster_scale_closure: PASS; value=1.0991; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7177; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2482; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1211; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=814.9364; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
