...
## Run Metadata
- Generated (UTC): 2026-04-06T00:52:10.289037+00:00
- Seed: 20260725
...
- Closure at R500, full eigenmode sum: 1.112
- Higher-mode fraction at R500: 0.050
- Mean memory factor at R500: 0.936
- Predicted sigma at R500: 819.6 km/s
...
- cluster_scale_closure: PASS; value=1.1118; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7353; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2580; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1196; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=819.6344; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
