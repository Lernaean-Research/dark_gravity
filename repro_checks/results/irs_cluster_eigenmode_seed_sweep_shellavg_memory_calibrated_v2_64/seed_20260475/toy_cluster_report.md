...
## Run Metadata
- Generated (UTC): 2026-04-06T00:51:17.935359+00:00
- Seed: 20260475
...
- inner_profile_reasonable: PASS; value=0.7052; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2422; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1221; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=811.2129; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
