...
## Run Metadata
- Generated (UTC): 2026-04-06T00:51:32.645197+00:00
- Seed: 20260545
...
- Closure at R500, ground mode only: 1.064
- Closure at R500, full eigenmode sum: 1.114
- Higher-mode fraction at R500: 0.051
- Mean memory factor at R500: 0.936
- Predicted sigma at R500: 820.4 km/s
...
- cluster_scale_closure: PASS; value=1.1140; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7368; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2551; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1199; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=820.4343; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
