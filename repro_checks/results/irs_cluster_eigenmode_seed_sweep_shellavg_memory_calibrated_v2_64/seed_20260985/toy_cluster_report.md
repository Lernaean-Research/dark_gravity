...
## Run Metadata
- Generated (UTC): 2026-04-06T00:53:04.114760+00:00
- Seed: 20260985
...
- Predicted sigma at R500: 816.0 km/s
...
- cluster_scale_closure: PASS; value=1.1021; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7039; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2547; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1208; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=816.0361; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
