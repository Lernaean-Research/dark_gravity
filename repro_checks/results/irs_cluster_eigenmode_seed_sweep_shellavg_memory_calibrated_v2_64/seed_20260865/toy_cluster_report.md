...
## Run Metadata
- Generated (UTC): 2026-04-06T00:52:39.208922+00:00
- Seed: 20260865
...
- Closure at R500, ground mode only: 1.031
- Closure at R500, full eigenmode sum: 1.080
- Higher-mode fraction at R500: 0.052
- Mean memory factor at R500: 0.936
- Predicted sigma at R500: 807.7 km/s
- Anchor sigma: 747.7 km/s
- Baryon fraction at R500: 0.123

## Gate Summary
- higher_modes_non_negligible: PASS; value=0.0518; criterion=0.05 <= higher_mode_fraction(R500) <= 0.55
- closure_improves_with_modes: PASS; value=0.0490; criterion=closure_full(R500) > closure_ground(R500)
- cluster_scale_closure: PASS; value=1.0797; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.6895; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2314; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1231; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=807.6983; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
