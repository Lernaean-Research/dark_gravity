...
## Run Metadata
- Generated (UTC): 2026-04-06T00:52:06.106103+00:00
- Seed: 20260705
...
- Closure at R500, full eigenmode sum: 1.110
- Higher-mode fraction at R500: 0.051
- Mean memory factor at R500: 0.936
- Predicted sigma at R500: 818.8 km/s
...
- cluster_scale_closure: PASS; value=1.1096; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7041; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2518; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1206; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=818.7980; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
