...
## Run Metadata
- Generated (UTC): 2026-04-06T00:52:18.433352+00:00
- Seed: 20260765
...
- Predicted sigma at R500: 816.2 km/s
...
- cluster_scale_closure: PASS; value=1.1024; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7099; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2396; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1216; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=816.1516; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
