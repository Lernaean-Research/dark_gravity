...
## Run Metadata
- Generated (UTC): 2026-04-06T00:47:14.795783+00:00
- Seed: 20260405
...
- Closure at R500, ground mode only: 0.834
- Closure at R500, full eigenmode sum: 0.860
- Higher-mode fraction at R500: 0.036
- Mean memory factor at R500: 0.436
- Predicted sigma at R500: 720.8 km/s
- Anchor sigma: 747.7 km/s
- Baryon fraction at R500: 0.155

## Gate Summary
- higher_modes_non_negligible: FAIL; value=0.0358; criterion=0.05 <= higher_mode_fraction(R500) <= 0.55
- closure_improves_with_modes: PASS; value=0.0260; criterion=closure_full(R500) > closure_ground(R500)
- cluster_scale_closure: PASS; value=0.8599; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: FAIL; value=0.4700; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.0268; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1550; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=720.8338; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
