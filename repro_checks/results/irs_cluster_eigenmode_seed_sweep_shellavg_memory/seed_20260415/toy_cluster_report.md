...
## Run Metadata
- Generated (UTC): 2026-04-06T00:47:16.846007+00:00
- Seed: 20260415
...
- Closure at R500, ground mode only: 0.811
- Closure at R500, full eigenmode sum: 0.837
- Higher-mode fraction at R500: 0.037
- Mean memory factor at R500: 0.436
- Predicted sigma at R500: 711.4 km/s
- Anchor sigma: 747.7 km/s
- Baryon fraction at R500: 0.159

## Gate Summary
- higher_modes_non_negligible: FAIL; value=0.0371; criterion=0.05 <= higher_mode_fraction(R500) <= 0.55
- closure_improves_with_modes: PASS; value=0.0262; criterion=closure_full(R500) > closure_ground(R500)
- cluster_scale_closure: PASS; value=0.8375; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: FAIL; value=0.4755; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=0.9932; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1589; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=711.3696; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
