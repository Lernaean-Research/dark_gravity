...
## Run Metadata
- Generated (UTC): 2026-04-06T00:47:27.442786+00:00
- Seed: 20260465
...
- Closure at R500, ground mode only: 0.846
- Closure at R500, full eigenmode sum: 0.872
- Higher-mode fraction at R500: 0.035
- Mean memory factor at R500: 0.436
- Predicted sigma at R500: 725.9 km/s
- Anchor sigma: 747.7 km/s
- Baryon fraction at R500: 0.153

## Gate Summary
- higher_modes_non_negligible: FAIL; value=0.0353; criterion=0.05 <= higher_mode_fraction(R500) <= 0.55
- closure_improves_with_modes: PASS; value=0.0261; criterion=closure_full(R500) > closure_ground(R500)
- cluster_scale_closure: PASS; value=0.8720; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: FAIL; value=0.5061; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.0324; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1527; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=725.8683; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
