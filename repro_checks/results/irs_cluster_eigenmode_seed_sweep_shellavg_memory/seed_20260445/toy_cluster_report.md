...
## Run Metadata
- Generated (UTC): 2026-04-06T00:47:23.401846+00:00
- Seed: 20260445
...
- Closure at R500, ground mode only: 0.844
- Closure at R500, full eigenmode sum: 0.870
- Higher-mode fraction at R500: 0.035
- Mean memory factor at R500: 0.436
- Predicted sigma at R500: 725.2 km/s
...
- cluster_scale_closure: PASS; value=0.8705; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: FAIL; value=0.4924; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.0369; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1528; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=725.2389; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
