...
## Run Metadata
- Generated (UTC): 2026-04-06T00:47:55.582717+00:00
- Seed: 20260435
...
- Closure at R500, ground mode only: 1.063
- Closure at R500, full eigenmode sum: 1.111
- Higher-mode fraction at R500: 0.050
- Mean memory factor at R500: 0.915
- Predicted sigma at R500: 819.5 km/s
- Anchor sigma: 747.7 km/s
- Baryon fraction at R500: 0.120

## Gate Summary
- higher_modes_non_negligible: FAIL; value=0.0497; criterion=0.05 <= higher_mode_fraction(R500) <= 0.55
- closure_improves_with_modes: PASS; value=0.0486; criterion=closure_full(R500) > closure_ground(R500)
- cluster_scale_closure: PASS; value=1.1114; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7113; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2535; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1204; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=819.4818; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
