...
## Run Metadata
- Generated (UTC): 2026-04-06T00:48:00.303898+00:00
- Seed: 20260455
...
- Predicted sigma at R500: 814.5 km/s
- Anchor sigma: 747.7 km/s
- Baryon fraction at R500: 0.122

## Gate Summary
- higher_modes_non_negligible: PASS; value=0.0503; criterion=0.05 <= higher_mode_fraction(R500) <= 0.55
- closure_improves_with_modes: PASS; value=0.0485; criterion=closure_full(R500) > closure_ground(R500)
- cluster_scale_closure: PASS; value=1.0979; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7148; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2430; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1216; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=814.4799; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
