...
## Run Metadata
- Generated (UTC): 2026-04-06T00:47:53.240748+00:00
- Seed: 20260425
...
- closure_improves_with_modes: PASS; value=0.0487; criterion=closure_full(R500) > closure_ground(R500)
- cluster_scale_closure: PASS; value=1.1086; criterion=0.65 <= closure_full(R500) <= 1.20
- inner_profile_reasonable: PASS; value=0.7184; criterion=0.65 <= closure_full(0.5 R500) <= 1.35
- outer_profile_not_divergent: PASS; value=1.2505; criterion=0.50 <= closure_full(1.4 R500) <= 1.50
- baryon_fraction_physical: PASS; value=0.1206; criterion=0.10 <= f_b(R500) <= 0.22
- velocity_dispersion_anchor: PASS; value=818.4350; criterion=|sigma_pred - sigma_anchor| / sigma_anchor <= 0.25
